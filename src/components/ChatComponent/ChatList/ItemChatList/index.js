...
function ItemChatList() {
  return (
    <div className='border-b flex justify-between items-center px-5 py-2 min-h-[74px] rounded transition-all hover:cursor-pointer hover:bg-gray-100'>
      <div className='flex items-center gap-5'>
        <div className='inline-flex relative'>
          <img className='w-16 h-16 rounded-full border border-gray-300' src={avatar} alt='avatar user'/> 
          <div className='w-3 h-3 rounded-full bg-green-600 absolute right-0 bottom-0'></div>     
        </div>
