...
function MessageBoard() {
  ...
  return (
    <div className='flex flex-col h-full'>
        <>
            <div className='min-h-[80px] border-b-[2px] flex items-center justify-between py-5 px-8'>
                <div className='flex items-center gap-4'>
                    <div className='inline-flex relative'>
                        <img className='w-16 h-16 rounded-full border border-gray-300' src={avatar} alt='avatar user'/> 
                        <div className='w-4 h-4 rounded-full bg-green-600 absolute right-0 bottom-0'></div>     
                    </div>
                    <div className='flex flex-col'>
                        <span className='text-[16px] font-semibold text-gray-700'>Phan Trọng Tính</span>
                        <span className='text-[12px] italic'>Đang hoạt động</span>
                    </div>
                </div>
                <button className='hover:bg-gray-200 transition-all p-4 rounded-full'>
                    <FiX  className='text-gray-400 text-[20px]'/>
                </button>
            </div>
            <div className='flex flex-col gap-10 px-8 py-5 h-full relative'>
                <div className='max-h-[80%] overflow-y-scroll flex flex-col gap-y-5 p-5'>
                    {
                ...
                <div className="flex flex-col border border-[#cccccc] rounded-2xl p-5">
                    ...
                    <div className={`${files.length > 0 && "mt-4"} flex items-center justify-between gap-5`}>
                        <input placeholder='Nhập tin nhắn' className='w-full text-[14px]'/>
                        <div className='gap-4 flex items-center'>
                            ...
                            />
                            <BsFillSendFill className="w-10 h-9 text-[#299899] hover:cursor-pointer hover:text-[#005759]"/>
                        </div>
                    </div>
                </div>
            </div>
        ...
        {/* <div className="flex flex-col h-full justify-center items-center relative">
            <button className='hover:bg-gray-200 transition-all p-4 rounded-full absolute top-10 right-10'>
                <FiX  className='text-gray-400 text-[20px]'/>
            </button>
            <span className='text-center text-[#299899] font-semibold text-[30px] italic'>Chào mừng bạn đến với kênh chat của GIVE-FUN</span>
