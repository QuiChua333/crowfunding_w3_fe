...
import { useUpdateFieldMutation } from "~/hooks/api/mutations/admin/admin.field.mutation";
import { setLoading } from "~/redux/slides/GlobalApp";

function ModalEdit({ setOpenModal, item, getAllFieldByGroup}) {
  const dispatch = useDispatch();
    ...
    const updateFiled = useUpdateFieldMutation();
