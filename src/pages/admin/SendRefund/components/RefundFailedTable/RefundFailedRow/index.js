...
function RefundFailedRow({ index, campaign, getAllCampaigns }) {
      ...
      <td className={cx('status')}>
        <span
          className={cx('campaign-status', {
            dangGayQuy: campaign.isRefund,

            thatBai: !campaign.isRefund,
          })}
        >
          {campaign.isRefund ? 'Đã hoàn trả' : 'Chưa hoàn trả'}
        </span>
      </td>
...
export default RefundFailedRow;
