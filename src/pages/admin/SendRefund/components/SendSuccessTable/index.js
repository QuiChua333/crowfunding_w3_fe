...
import CampaignRow from './SendSuccessRow';
import { useEffect, useState } from 'react';
import { convertDateFromString } from '~/utils';
import SendSuccessRow from './SendSuccessRow';

const cx = classNames.bind(styles);

function SendSuccessTable({ campaigns, getAllCampaigns, handleClickRow }) {
...
export default SendSuccessTable;
