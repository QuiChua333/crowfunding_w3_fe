      ...
      <td className={cx('action')}>
        ...
        >
          ...
          <div
            ...
            style={{ display: openDropDown && 'block', pointerEvents: !isEditComponent && 'none' }}
          >
            <DropDown
              setShowModalGivePerk={setShowModalGivePerk}
              setUserContributionGivePerk={handleSetUserContributionGivePerk}
            />
          </div>
        </div>
      </td>
